...
void addOnlineUser   (const QString& userId, const QString& displayName, const QString& username,
                       const QString& bio, const QString& photoData = QString());
...
void showProfileDialog(const Message& msg);
...
QMap<QString, QStringList> roomLog_; 
QSet<QString> historyRequested_;
