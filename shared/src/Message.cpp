...
std::string Message::typeToString(MessageType t)
{
    ...
    case MessageType::QA_GET_FAQ:       return "QA_GET_FAQ";
    ...
    case MessageType::PROFILE_VIEW:     return "PROFILE_VIEW";
...
MessageType Message::stringToType(const std::string& s)
{
    ...
    if (s == "QA_GET_FAQ")      return MessageType::QA_GET_FAQ;
    ...
    if (s == "PROFILE_VIEW")    return MessageType::PROFILE_VIEW;
